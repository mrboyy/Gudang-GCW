...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        ...
        <div class="text-muted" style="font-size:.78rem;">Barang yang dikembalikan dari produksi masuk kembali ke stok gudang</div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        Data Barang yang Dikembalikan dari Produksi
    </div>
    ...
    <div class="card-body p-4">
        ...
        {{-- No. Ref Transaksi Keluar Internal --}}
        <div class="mb-4">
            ...
            <select name="no_ref" class="form-select" id="refSelect" required>
                ...
                <option value="{{ $tk->no_surat_jalan }}"
                    ...
                    {{ $tk->no_surat_jalan }} — {{ $tk->barang->nama_barang }} (sisa: {{ $sisa }} {{ $tk->barang->satuan }}) · {{ $tk->tujuan_keluar }}
                </option>
                @endforeach
            </select>
    ...
    <div class="card-footer d-flex justify-content-end gap-2">
        ...
        <button type="submit" class="btn btn-primary px-5" id="submitBtnReturP">Simpan Retur</button>
    </div>
    </form>
</div>
...
document.querySelector('form').addEventListener('submit', function() {
    const btn = document.getElementById('submitBtnReturP');
    btn.disabled = true;
